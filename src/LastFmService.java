...
public interface LastFmService {
    ...
    @GET("/2.0/?method=chart.gettopartists&api_key=4be54cb5b332c47b96dce8d0229276f8&format=json&limit=50")
    ...
    class Authenticator implements Interceptor {
        ...
        public Response intercept(Chain chain) throws IOException {
            HttpUrl url = chain
                    ...
                    .url()
                    .newBuilder()
                    .addQueryParameter("453be5e4ea1fec4b853787d4bcd664a5", apiKey)
                    .build();
